...
const char* ssid = "Nokia 5.4";             // REPLACE mySSID WITH YOUR WIFI SSID
const char* pass = "665ef18d1155";          // REPLACE myPassword YOUR WIFI PASSWORD, IF ANY
const char* token = "6566034430:AAFj9i9RNRcrk7ya2R2fkxiRX4RwOzapO_c";     // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN


// Check the userid with the help of bot @JsonDumpBot or @getidsbot (work also with groups)
// https://t.me/JsonDumpBot  or  https://t.me/getidsbot
int64_t userid = 5308665562;  
...
int lampChannel = 4;           // a free PWM channel (some channels used by camera)
